...
export const getUserDaycares = () => async dispatch => {
  try {
    const res = await axios.get(
      'https://cors-anywhere.herokuapp.com/https://daycaremanagerserver.azurewebsites.net/api/daycares/me'
    );
...
export const getDaycares = () => async dispatch => {
  ...
  try {
    const res = await axios.get(
      'https://cors-anywhere.herokuapp.com/https://daycaremanagerserver.azurewebsites.net/api/daycares'
    );
...
export const getDaycareById = id => async dispatch => {
  try {
    const res = await axios.get(
      `https://cors-anywhere.herokuapp.com/https://daycaremanagerserver.azurewebsites.net/api/daycares/${id}`
    );
...
export const addClassroom = (
  ...
  try {
    ...
    const res = await axios.put(
      `https://cors-anywhere.herokuapp.com/https://daycaremanagerserver.azurewebsites.net/api/daycare/classroom/${daycareId}`,
      formData,
      config
    );
...
export const deleteClassroom = (daycareId, classroomId) => async dispatch => {
  try {
    const res = await axios.delete(
      `https://cors-anywhere.herokuapp.com/https://daycaremanagerserver.azurewebsites.net/api/daycare/classroom/${daycareId}/${classroomId}`
    );
